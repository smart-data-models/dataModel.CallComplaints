...
class CallUser(BaseModel):
    ...
    aliasName: Optional[str] = Field(
        None, description='The alias name of the User to protect privacy'
    )
    ...
    contactPhone: Optional[str] = Field(
        None, description='The contact phone of the User'
    )
    ...
    makesComplaints: Optional[List[AnyUrl]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI-LD Entity Type. It must be equal to CallUser'
    )

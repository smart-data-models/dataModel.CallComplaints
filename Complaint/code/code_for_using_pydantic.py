...
class Complaint(BaseModel):
    ...
    ] = Field(None, description='The Id of the User that made this Complaint')
    isPartOf: Optional[
        List[
            Union[
                constr(
    ...
    status: Optional[str] = Field(
        None, description='Status of the Complaint. Examples: Pending, In progress'
    )
    timestamp: Optional[AwareDatetime] = Field(
        None, description='The timestamp of the Complaint'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI Entity Type. It must be equal to Complaint'
    )
